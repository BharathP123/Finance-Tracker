...
    <div className="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
  <div className="bg-white dark:bg-gray-800 rounded-t-2xl sm:rounded-2xl w-full max-w-md max-h-[95vh] sm:max-h-[90vh] flex flex-col overflow-hidden">
    {/* Header */}
    ...
    {/* Scrollable Content */}
    <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4 sm:space-y-6 flex-1 overflow-y-auto pb-16 sm:pb-20">
      {/* Type Toggle */}
      <div className="flex bg-gray-100 dark:bg-gray-700 rounded-xl p-1">
        <button
          type="button"
          onClick={() => setFormData(prev => ({ ...prev, type: 'expense' }))} // Set to Expense
        ...
        <button
          type="button"
          onClick={() => setFormData(prev => ({ ...prev, type: 'income' }))} // Set to Income
          className={`flex-1 flex items-center justify-center space-x-2 py-3 rounded-lg transition-all duration-200 touch-manipulation ${
